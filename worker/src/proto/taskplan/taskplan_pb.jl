# Autogenerated using ProtoBuf.jl v1.2.0 on 2026-04-25T21:04:37.443
...
PB.default_values(::Type{TaskDef}) = (;label = "", frequency = zero(Int32), workload = zero(Int32))
PB.field_numbers(::Type{TaskDef}) = (;label = 1, frequency = 2, workload = 3)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:TaskDef})
    ...
    return TaskDef(label, frequency, workload)
end
